 		<form id="container"  method="post" action="<?=base_url('alumni/kuesioner'); ?>">
		<div id="pembungkusjudul">
			<h2>Tracer Study</h2><br>
		...
		<div id="pembungkus1">
			<div id="kanan">
				<div id="pembungkuslabelinput1">
					<div id="divlabel">
						<label for="nama">Npm</label>
					</div>
					<div id="divinputtext">
						<input type="text" maxlength="12" name="npm" value="<?= $alumni['npm'] ?>"  readonly><?= form_error('npm', '<small class="eror">', '</small>') ?>	
					</div>
				</div>
				...
				<div id="pembungkuslabelinput1">
					...
					<div id="divinputtext">
						<input type="text" maxlength="65" name="nm_mahasiswa" value="<?= $alumni['nm_mahasiswa'] ?>" readonly><?= form_error('nm_mahasiswa', '<small class="eror">', '</small>') ?>
					</div>
				</div>
				...
				<div id="pembungkuslabelinput1">
					...
					<div id="divinputtext">
						<input  type="date" name="tgl_lahir" value="<?= $alumni['tgl_lahir'] ?>" ><?= form_error('tgl_lahir', '<small class="eror">', '</small>') ?>
					</div>
				</div>
				<div id="pembungkuslabelinput1">
					<div id="divlabel">
					...
					<div id="divinputtext">
						<select  name='prodi'>
							<option <?php if ($alumni['prodi'] == ""): ?> selected="selected"<?php endif; ?> ></option>
							<option <?php if ($alumni['prodi'] == "INFORMATIKA"): ?> selected="selected"<?php endif; ?> >INFORMATIKA</option>
							</select><?= form_error('prodi', '<small class="eror">', '</small>') ?>
						</div>
					</div> 
				</div>
				<div id="kiri">
					<div id="pembungkuslabelinput1">
						...
						<div id="divinputtext">
							<input type="text" name="thn_lulus" value="<?= $alumni['thn_lulus'] ?>" readonly><?= form_error('thn_lulus', '<small class="eror">', '</small>') ?>
						</div>
					</div>
					...
					<div id="pembungkuslabelinput1">
						...
						<div id="divinputtext">
							<input style="resize: none" rows="2" maxlength="126" name="alamat" value="<?= $alumni['alamat'] ?>"><?= form_error('alamat', '<small class="eror">', '</small>') ?>
						</div>
					</div>
					...
					<div id="pembungkuslabelinput1">
						...
						<div id="divinputtext">
							<input type="number" maxlength="20" name="no_telp" value="<?= $alumni['no_telp'] ?>"><?= form_error('no_telp', '<small class="eror">', '</small>') ?>	
						</div>
					</div>

					<div id="pembungkuslabelinput1">
						<div id="divlabel">
							<label>Email/FB/Twitter</label>
						</div>
						<div id="divinputtext">
							<input type="text" name="email" value="<?= $alumni['email'] ?>"  ><?= form_error('email', '<small class="eror">', '</small>') ?>
						</div>
					</div>
				</div>
			</div>
			<div id="pembungkus2">
				<div id="pembungkuslabelinput2">
					...
					<div id="divinputtext">
						<input type="text" class="input" autocomplete="off" name="a1" value="<?= $studytracer['a1'] ?>" ><?= form_error('a1', '<small class="eror">', '</small>') ?>
					</div>
				</div>
				<div id="pembungkuslabelinput2">
					<div id="divlabel">
				...
				<div id="myDropdown3">
					<div  class="pembungkuslabelinput2">
						<div id="divlabel">
							<label>Nama Perusahaan</label>
						</div>
						<div id="divinputtext">
							<input autocomplete="off" type="text" id="pekerjaan" class="input" name="a4" value="<?= $studytracer['a4'] ?>">
						</div>
					</div>
					<div class="pembungkuslabelinput2">
						<div id="divlabel">
						...
						<div id="divinputtext">
							<input autocomplete="off" type="text" id="pekerjaan" class="input" name="a5" value="<?= $studytracer['a5'] ?>">
						</div>
					</div>
					<div class="pembungkuslabelinput2">
						<div id="divlabel">
						...
						<div id="divinputtext">
							<input autocomplete="off" type="text" id="pekerjaan" class="input" name="a6" value="<?= $studytracer['a6'] ?>">
						</div>
					</div>
				</div>
				<div id="pembungkuslabelinput2">
																...
																<label><p><input type="Checkbox"  name="a16[]" value="Saya sibuk dengan keluarga dan anak-anak" 
																	...
																	<label><p><input type="Checkbox"  name="a16[]" value="Saya sekarang sedang mencari pekerjaan"
																		...
																		<label><p><input type="Checkbox"  name="a16[]" value="Saya sedang bekerja"
																			...
																			<label><p>
															lainnya
															<input id="lainnya-a12" class="lainnya_input" type="text"  name="a16[]" value="<?php 
															$a = explode(",", $studytracer['a16']);
															$b = array("Saya masih belajar melanjutkan kuliah profesi atau pascasarjana","Saya Menikah","Saya sibuk dengan keluarga dan anak-anak","Saya sekarang sedang mencari pekerjaan","Saya sedang bekerja");
															$c = array_diff($a,$b);
															$d = implode("", $c);
															echo "$d";
															?>">
																												...
																												<label><p><input type="Checkbox"  name="a19[]" value="Pekerjaan saat ini lokasinya lebih dekat dengan rumah"
																													...
																													<label><p><input type="Checkbox"  name="a19[]" value="Pekerjaan saat ini dapat menjamin kebutuhan keluarga saya"
																														...
																														<label><p><input type="Checkbox"  name="a19[]" value="Pada awal meniti karir saya harus menerima pekerjaan yang berhubungan dengan pendidikan saya"
																															...
																															<label><p>
															lainnya
															<input id="lainnya-a12" class="lainnya_input" type="text"  name="a19[]" value="<?php 
															$a = explode(",", $studytracer['a19']);
															$b = array("Pekerjaan saya sekarang sudah sesuai dengan pendidikan saya","Saya mendapat pekerjaan yang lebih sesuai","Di pekerjaan ini saya memperoleh kesempatan karir yang lebih baik","Saya lebih suka bekerja di lingkungan yang tidak sesuai dengan pendidikan saya","Saya dipromosikan di tempat yang kurang sesuai dengan latar pendidikan","Saya memperoleh pendapatan yang lebih tinggi","Pekerjaan saat ini lebih aman/terjamin atau secure","Pekerjaan saya saat ini lebih menarik","Pekerjaan saat ini lebih memungkinkan pekerjaan tambahan yang fleksibel","Pekerjaan saat ini lokasinya lebih dekat dengan rumah","Pekerjaan saat ini dapat menjamin kebutuhan keluarga saya","Pada awal meniti karir saya harus menerima pekerjaan yang berhubungan dengan pendidikan saya");
															$c = array_diff($a,$b);
															$d = implode("", $c);
															echo "$d";
															?>">
...
<!--
	<div>Bagian 3</div>
-->
<div id="pembungkusjudul3">
	<p>Menurut Pendapat Anda, seberapa penting aspek-aspek berikut bagi pengembangan karir anda?</p>
    <p>Keterangan Jawaban 1= tidak penting ----------------------------- 5 = Sangat Penting</p>
</div>
<div id="pembungkus3">
	<div id="kiri3">
		<div id="pembungkuslabelinput3">
			<div class="divlabel">
				<label>Pengetahuan di bidang atau disiplin ilmu anda</label>
			</div>
			<div class="divinputradio3">
	...
	<div id="kanan3">
		...
		<div id="pembungkuslabelinput3">
			...
			<div class="divtextarea3">
				<textarea style="resize: none" rows="4" name="b30"><?=$studytracer2['b30'] ?></textarea><?= form_error('b30', '<small class="eror">', '</small>') ?>
			</div>
		</div>
</div>
</div>
